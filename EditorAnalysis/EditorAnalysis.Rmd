...
bind_rows(board_f.tbl,board_i.tbl) %>%
  ...
  ggplot(aes(x=fct_relevel(FAC_ROLE,"chief","editor","review"),
    ...
    labs(y="Diversity",x="",title="Diversity of Journal Boards",
         caption = str_wrap(paste0("Bars represent 95% CI. Diversity is mean of individual boards. Pooled-Chief shows diversity of entire category pool. ", "N = ", boardn),100))+
